export default function Banner() {
    return(
        <div className="active:scale-99 active:brightness-80 transition-transform duration-100 hover:shadow-md">
            <a href="https://github.com/stickfig8/my-nextjs-blog" target="_blank" className="cursor-pointer" title="blog project repository">
